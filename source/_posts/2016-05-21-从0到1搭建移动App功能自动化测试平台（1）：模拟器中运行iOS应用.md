...
permalink: post/build-app-AutomationTest-platform-from-0-to-1-Appium-inspector-iOS-simulator
...
![](/images/Appium_iOS_Settings_init.jpg)
...
![](/images/Appium_Inspector_Button.jpg)

然后，点击图中红框处的按钮，即可通过`Inspector`启动模拟器，并在模拟器中加载iOS应用。

![](/images/Appium_iOS_Simulator_Console.jpg)
...
![](/images/Appium_Inspector_Error.jpg)
...
![](/images/Appium_iOS_Settings_bug.jpg)
